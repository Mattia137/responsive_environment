/* =========================================================================
   ALLSPARK // IMPACT  ·  layers/registry.js
...
/* Short descriptions + sources for the left-panel expand detail.
   Keep these concise — the CLAUDE_CODE_PROMPT.md has the authoritative
   full source list that Claude Code should copy into here. */
export const LAYER_DETAILS = {
  air: {
    note: 'Construction-phase PM2.5 spike dominates near-term impact; HVAC NO₂ and induced vehicle trips drive steady-state.',
